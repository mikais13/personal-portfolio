  ...
  return (
    ...
    >
      <PageSection title="Kia Ora!">
        ...
        <p className="intro">
          Passionate about building things and solving interesting problems. I've had the chance
          to intern at Generate Zero and PGG Wrightson, and I'm always on the lookout for what's
          next. Feel free to reach out on LinkedIn!
        </p>
      </PageSection>
      <PageSection title="At a Glance">
        <SummaryCarousel personal={personal} professional={professional} />
      </PageSection>
